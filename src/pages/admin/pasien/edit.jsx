...
export default function EditPasien() {
  // Ambil ID pasien dari parameter URL (misal: /admin/pasien/edit/5)
  const { id } = useParams();
        ...
        <form onSubmit={handleSubmit} onReset={handleReset}>
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div className="p-6 space-y-6">
              ...
              <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 flex flex-col justify-content center">
