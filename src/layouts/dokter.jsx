          ...
          <div className="px-3 sm:px-4 lg:px-6 py-3">
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-2 sm:space-x-4 flex-1">
                ...
                {/* Logo */}
                <Link to="/dokter" className="flex items-center space-x-1 sm:space-x-3 pr-9">
            ...
            <ul className="space-y-1">
              ...
              <li>
                <Link
                  to="/dokter/obat"
                  className={`flex items-center p-3 text-sm font-medium rounded-lg transition-all duration-200 group ${
                    isActive("/dokter/obat")
                      ? "bg-green-50 text-green-900"
                      : "text-gray-700 hover:bg-green-50 hover:text-green-900"
                  }`}
                >
                  <svg className={`w-5 h-5 transition-colors duration-200 ${
                    isActive("/dokter/obat") ? "text-green-900" : "text-gray-500 group-hover:text-green-900"
                  }`} fill="currentColor" viewBox="0 0 20 20">
              ...
              <li>
                <Link
                  to="/dokter/pasien"
                  className={`flex items-center p-3 text-sm font-medium rounded-lg transition-all duration-200 group ${
                    isActive("/dokter/pasien")
                      ? "bg-green-50 text-green-900"
                      : "text-gray-700 hover:bg-green-50 hover:text-green-900"
                  }`}
                >
                  <svg className={`w-5 h-5 transition-colors duration-200 ${
                    isActive("/dokter/pasien") ? "text-green-900" : "text-gray-500 group-hover:text-green-900"
                  }`} fill="currentColor" viewBox="0 0 20 20">
              ...
              <li>
                ...
                >
                  <svg className={`w-5 h-5 transition-colors duration-200 ${
                    isActive("/dokter/pemeriksaan") ? "text-green-900" : "text-gray-500 group-hover:text-green-900"
                  }`} fill="currentColor" viewBox="0 0 20 20">
